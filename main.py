...
middle_right_advance_setting_frame_row1_col1_label = tk.Label(middle_right_advance_setting_frame_row1, text="Cài đặt bổ sung", font=(font_name, 18, "bold"), bg=bg_app_color)
...
close_setting_frame_button = tk.Button(middle_right_setting_frame_row3, image=close_icon, command=close_frame, bg=bg_app_color, width=166, height=34, relief="flat", borderwidth=0)
...
close_advance_setting_frame_button = tk.Button(middle_right_advance_setting_frame_row3, image=close_icon, command=close_frame, bg=bg_app_color, width=260, height=34, relief="flat", borderwidth=0)
close_advance_setting_frame_button.grid(row=0, column=1, padx=5, pady=5, sticky="e")
